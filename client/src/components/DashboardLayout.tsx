...
import { LayoutDashboard, LogOut, PanelLeft, Users, Settings, Trophy, Zap, Download, Gift } from "lucide-react";
...
const getMenuItems = (t: (key: string) => string) => [
  ...
  { icon: Zap, labelKey: "nav.challenges", path: "/challenges" },
  { icon: Gift, labelKey: "nav.rewards", path: "/rewards" },
  { icon: Download, labelKey: "nav.export", path: "/export" },
